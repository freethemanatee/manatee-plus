...
public class KillAura extends Module {
    ...
    public void setup(){
        ...
        ManateePlus.getInstance().settingsManager.rSetting(criticals = new Setting("kaCriticals", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(swordOnly = new Setting("kaSwordOnly", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(caCheck = new Setting("CAuraCheck", this, false));
