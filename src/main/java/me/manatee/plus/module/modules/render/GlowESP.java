...
public class GlowESP extends Module {
    ...
    public void setup(){
        ManateePlus.getInstance().settingsManager.rSetting(players = new Setting("gPlayers", this, true));
        ManateePlus.getInstance().settingsManager.rSetting(passive = new Setting("gPassive", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(monsters = new Setting("gMonsters", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(items = new Setting("gItems", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(crystals = new Setting("gCrystals", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(xpBottles = new Setting("gXpBottles", this, false));
    }
