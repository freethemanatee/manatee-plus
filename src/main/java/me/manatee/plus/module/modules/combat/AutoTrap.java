...
public class AutoTrap extends Module {
    ...
    public void setup(){
        ManateePlus.getInstance().settingsManager.rSetting(rotate = new Setting("atRotate", this, true));
        ManateePlus.getInstance().settingsManager.rSetting(ec = new Setting("atUseEchests", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(range = new Setting("atRange", this, 5, 0, 10, false));
        ManateePlus.getInstance().settingsManager.rSetting(bpt = new Setting("atBlocksPerTick", this, 8, 1, 15, true));
    }
