...
public class CropNuker extends Module {
    public CropNuker() {
        ...
        ManateePlus.getInstance().settingsManager.rSetting(range = new Setting("cnRange", this, 4.5, 0, 10, false));
        ManateePlus.getInstance().settingsManager.rSetting(tickDelay = new Setting("cnTickDelay", this, 5, 0, 100, true));
    }
