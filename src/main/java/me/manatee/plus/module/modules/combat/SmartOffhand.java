...
public class SmartOffhand extends Module {
    ...
    public void setup(){
        ...
        items.add("Crystal");
        items.add("Gapple");
        ManateePlus.getInstance().settingsManager.rSetting(health = new Setting("soHealth", this, 10, 1, 40, true));
        ManateePlus.getInstance().settingsManager.rSetting(crystalCheck = new Setting("soCrystalCheck", this, false));
        ManateePlus.getInstance().settingsManager.rSetting(itemSetting = new Setting("soItem", this, "Crystal", items));
    }
