...
import me.manatee.plus.module.modules.gui.Coords;
...
public class CoordsComponent extends Panel {
    ...
    public void drawHud(){
        ...
        if(font)
            ManateePlus.fontRenderer.drawStringWithShadow(getCoords(), (int) x, (int) y, c.getRGB());
        else
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(getCoords(), (float) x, (float) startY, text.getRGB());
