...
import me.manatee.plus.module.modules.gui.Crystals;
...
public class CrystalsComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        if(font) ManateePlus.fontRenderer.drawStringWithShadow(cry, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(cry, (float) x, (float) startY, text.getRGB());
