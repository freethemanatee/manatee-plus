...
import me.manatee.plus.module.modules.gui.Watermark;
...
public class WatermarkComponent extends Panel {
    ...
    public void drawHud(){
        ...
        if(font) ManateePlus.fontRenderer.drawStringWithShadow(s, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(s, (float) x, (float) startY, text.getRGB());
