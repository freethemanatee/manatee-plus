...
import me.manatee.plus.module.modules.gui.Bps;
...
public class BpsComponent extends Panel {
    ...
    public void drawHud(){
        ...
        if(font) ManateePlus.fontRenderer.drawStringWithShadow(bps, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(bps, (float) x, (float) startY, text.getRGB());
