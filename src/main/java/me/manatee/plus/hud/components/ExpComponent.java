...
import me.manatee.plus.module.modules.gui.Exp;
...
public class ExpComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        if(font) ManateePlus.fontRenderer.drawStringWithShadow(exp, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(exp, (float) x, (float) startY, text.getRGB());
