...
import me.manatee.plus.module.modules.gui.WelcomerGui;
...
public class WelcomerComponent extends Panel {
    ...
    public void drawHud(){
        doStuff();
        if(font) ManateePlus.fontRenderer.drawStringWithShadow(msg, (float)x, (float)y, text.getRGB());
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks){
        ...
        if(extended) {
            ...
            if (font) ManateePlus.fontRenderer.drawStringWithShadow(msg, (float) x, (float) startY, text.getRGB());
