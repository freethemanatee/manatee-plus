...
//Credit 086
public class ManateePlusTessellator extends Tessellator {

    public static ManateePlusTessellator INSTANCE = new ManateePlusTessellator();

    public ManateePlusTessellator() {
        super(0x200000);
    }
