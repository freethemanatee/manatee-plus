...
public class Panel {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		}else if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike")){
			Gui.drawRect((int)x, (int)y, (int)x + (int)width, (int)y + (int)height, 0xff121212);
		...
		}else if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("f0nzi")) {
		...
		}else if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Windows")){
		...
		if (this.extended && !Elements.isEmpty()) {
			...
			int epanelcolor = ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New") ? 0xff232323 :
					ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("JellyLike") ? 0xbb151515 :
					ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("f0nzi") ? 0xbb303030 :
					ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Windows") ? 0xffffffff : 0;
			for (ModuleButton et : Elements) {
				if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("New")){
					Gui.drawRect((int)x - 2, (int)startY, (int)x + (int)width, (int)startY + (int)et.height + 1, outlineColor);
				}
				if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("f0nzi")){
				...
				if(ManateePlus.getInstance().settingsManager.getSettingByName("Design").getValString().equalsIgnoreCase("Windows")){
